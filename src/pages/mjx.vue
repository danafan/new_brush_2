...
<script>
	...
	export default{
		data(){
			return{
				tab_list:[{
					img:require('../static/dcl_icon.png'),
					active_img:require('../static/dcl_icon_active.png'),
					name:'待处理',
					status:2
				},{
					img:require('../static/tjz_icon.png'),
					active_img:require('../static/tjz_icon_active.png'),
					name:'提交中',
					status:3
				},{
					img:require('../static/yjj_icon.png'),
					active_img:require('../static/yjj_icon_active.png'),
					name:'已拒绝',
					status:5
				},{
					img:require('../static/ywc_icon.png'),
					active_img:require('../static/ywc_icon_active.png'),
					name:'已完成',
					status:4
				}],
